...
class ClassParamExplanationInput(BaseModel):
...
class ClassParamExplanation(BaseTool):
    name = "get_class_param_explanation"
    description = """
        Useful when you want an explanation of what the parameters in a class do.
        ...
        """
    args_schema: Type[BaseModel] = ClassParamExplanationInput
